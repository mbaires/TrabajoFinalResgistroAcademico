    ...
    <div id="templatemo_menu">
       <ul>
            ...
            <?php
             ...
             {
               ?>
               <li><a href="../mantenimiento/usuarios.php" class="current">USUARIOS</a></li>
               <?php
             }
            ?>
...
<li><a href="../herramientas/herramientas.php" >AYUDA</a></li>
    ...
    <div id="templatemo_main">
		...
		<div class="post_box">
                ...
                <iframe name="contenido" width="745px" height="500px" frameborder="0" src="../contenUsuariousu.php"></iframe>
            </div>			
